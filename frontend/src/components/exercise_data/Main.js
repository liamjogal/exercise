...
function OrderBar() {
  ...
  const setDocument = (update=false, history=false, friends=false, settings=false) => {
  ...
  const handlePageChange = (event) => {
    ...
    return (
      <><AppBar id="menu-nav-bar" position="relative" color="transparent" sx={{height:75
      }} enableColorOnDark>
...
// Account button testing

{/* <Tooltip title="Account Info">
<IconButton aria-controls="user-menu" aria-haspopup="true" onClick={handleOpenUserMenu} sx={{ p: 0 }} onClose={handleCloseUserMenu} anchorEl={anchorElUser}>
